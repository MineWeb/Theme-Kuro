<div id="heading-breadcrumbs">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div style="border-top-left-radius: 0px;border-top-right-radius: 0px;" class="panel panel-default">
          <div class="panel-body">
            <div class="col-sm-2">
              <center><img src="<?= $this->Html->url(array('controller' => 'API', 'action' => 'get_head_skin', $user['pseudo'], '90')) ?>" alt="avatar"></center>
            </div>
            <div class="col-sm-10">
              <h2 style="margin-bottom: -40px;"><?= $user['pseudo'] ?></h2> <br />
              <h3><?= $user['email'] ?></h3>
            </div>
          </div>
        </div>
