  ...
  <div class="row">
    <div class="col-md-3">
        ...
        <div class="list-group">
            <?php
            $i = 0;
            foreach ($search_categories as $k => $v) {$i++;
            ?>
        ...
        <?php if(!$isConnected) { ?>
            <div class="alert alert-danger">
              Vous devez être connecté pour faire un achat
            </div>
        <?php } ?>
        ...
        <div class="row">
          ...
          ?>
                <div class="col-sm-<?= $col ?> col-lg-<?= $col ?> col-md-<?= $col ?>">
                    <div class="thumbnail">
                        <?php if(isset($v['Item']['img_url'])) { ?><br /><img style="width: 50%;" src="<?= $v['Item']['img_url'] ?>" alt=""><?php } ?>
